...
def summarize_results(results: Iterable[VerifierResult]) -> dict[str, object]:
...
def summarize_benchmark(traces: Iterable[TraceRecord], verifier: ArithmeticTraceVerifier | None = None) -> dict[str, object]:
    ...
    summary["final_accuracy"] = round(final_passes / len(trace_list), 4) if trace_list else 0.0
